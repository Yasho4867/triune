...
def default_config() -> dict[str, Any]:
    ...
    return {
        ...
        "use_muon": defaults.USE_MUON,
        "muon_lr": defaults.MUON_LR,
        "muon_momentum": defaults.MUON_MOMENTUM,
        "muon_weight_decay": defaults.MUON_WEIGHT_DECAY,
        "galore": defaults.GALORE,
        "galore_rank": defaults.GALORE_RANK,
        "galore_update_gap": defaults.GALORE_UPDATE_GAP,
        "galore_lr": defaults.GALORE_LR,
        "galore_betas": defaults.GALORE_BETAS,
        "galore_weight_decay": defaults.GALORE_WEIGHT_DECAY,
